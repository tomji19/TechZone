...
import { Menu, X, ShoppingBag, Zap, ShoppingCart, Search, User, LogOut, Plus, Minus } from "lucide-react";
...
export default function EyeCatchingHeader() {
  ...
  return (
    <header className="relative z-50 overflow-hidden px-4 sm:px-8 md:px-16">
      <div className="absolute inset-0 bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-950 shadow-xl">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute left-0 top-0 w-full h-full bg-[url('data:image/svg+xml;base64,')]" />
        </div>
      ...
      {isSearchOpen && (
        <div 
          ref={searchRef}
          className="fixed top-0 left-0 right-0 bg-white z-50 shadow-lg p-4 mt-16"
        >
      ...
      {isCartOpen && (
        <div
          ref={cartRef}
          className="fixed top-16 right-0 mt-2 w-full sm:w-96 bg-white rounded-lg shadow-xl z-50 border border-gray-100 max-h-[80vh] overflow-auto"
        >
          <div className="p-4">
